                ...
                <div style="margin-top:10px;">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <input type="text" class="col-sm-6 form-control name" value="{{ old('firstName') }}" maxlength="70" id="exampleInputEmail1" placeholder="First Name" name="firstName">
                            </div>
                            <div class="col-sm-3">
                                <label>Middle Name<span style="color:red;"></span></label>
                                <input type="text" class="col-sm-6 form-control name" value="{{ old('middleName') }}" maxlength="20" id="exampleInputEmail1" placeholder="Middle Name" name="middleName">
                            </div>
                            <div class="col-sm-3">
                                <label>Last Name<span style="color:red;">*</span></label>
                                <input type="text" class="col-sm-6 form-control name" maxlength="50" value="{{ old('lastName') }}" id="exampleInputEmail1" placeholder="Last Name" name="lastName">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            <div class="row">
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" class="col-sm-6 form-control" maxlength="70" value="{{ old('street') }}" id="exampleInputEmail1" placeholder="Street" name="street" >
                                </div>
                                <div class="col-sm-4">
                                    <label>Brgy.<span style="color:red;">*</span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('brgy') }}" id="exampleInputEmail1" placeholder="Brgy" name="brgy">
                                </div>
                                <div class="col-sm-3">
                                    <label>City<span style="color:red;">*</span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('city') }}" id="exampleInputEmail1" placeholder="City" name="city">
                                </div>
                            </div>
                    </div>
                    <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="col-sm-6 form-control" maxlength="100" value="{{ old('province') }}" id="exampleInputEmail1" placeholder="Province" name="province">
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('religion') }}" id="exampleInputEmail1" placeholder="Religion" name="religion">
                                </div>
                            </div>
                    </div>
                    <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class='input-group date' id='datetimepicker1'>
                                        <input type='text' name="birthdate" placeholder="YYYY-MM-DD" value="{{ old('birthdate') }}" id="bday"  class="form-control" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                    ...
                    <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="col-sm-6 form-control" value="{{ old('tinNo') }}" name="tinNo" id="tin" placeholder="Tin No.">
                                </div>
                                <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4">
                                    ...
                                    <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('contactNumber') }}" name="contactNumber" id="contactNumber" placeholder="Contact Number">
                            </div>
                            <div class="col-sm-4">
                                    <label>Voter's Id No.<span style="color:red;"></span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('voterId') }}"name="voterId" id="voterId" placeholder="Voter's Id No.">
                            </div>
                            <div class="col-sm-4">
                                    <label>Precint Assignment No.<span style="color:red;"></span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('precintNo') }}" name="precintNo" id="precint" placeholder="Precint Assignment No.">
                            </div>
                        </div>
                    </div>
                    <div class="" style="padding:10px; background:#252525; color:white;">
                    ...
                    <div class="row">
                            <div class="col-sm-6">
                                <label>First Name<span style="color:red;">*</span></label>
                                <input type="text" class="col-sm-6 form-control" maxlength="70" value="{{ old('motherFirstName') }}" name="motherFirstName" id="exampleInputEmail1" placeholder="First Name">
                            </div>
                            <div class="col-sm-3">
                                <label>Middle Name<span style="color:red;"></span></label>
                                <input type="text" class="col-sm-6 form-control" maxlength="20" value="{{ old('motherMiddleName') }}" name="motherMiddleName" id="exampleInputEmail1" placeholder="Middle Name">
                            </div>
                            <div class="col-sm-3">
                                <label>Last Name<span style="color:red;">*</span></label>
                                <input type="text" class="col-sm-6 form-control" maxlength="50" value="{{ old('motherLastName') }}" name="motherLastName" id="exampleInputEmail1" placeholder="Last Name">
                            </div>
                    </div>
                     </div>
                    <div class="" style="padding:10px; background:#252525; color:white;">
